...
import static com.example.okttp.Constant.NO_NET;
import static com.example.okttp.Constant.SERVER_ERROR;
...
public class Okhttp {
    ...
    public static void setHeader(OkHttpRequestBuilder builder) {
        String appversion = PublicUtls.getVerName(TreadApplication.getInstance());
...
//        builder.addHeader("sign", sign);
    ...
    public static void get(boolean isTokenId, final String url, Map param, final CallBac callBac) {
        boolean netState = NetUtils.isNetworkAvailable(TreadApplication.getInstance());
        ...
        builder.build()
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        LogUtils.e("服务器异常=" + e.getMessage());
                        callBac.onError(call, e, SERVER_ERROR, id);
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.e("返回信息=" + response);
    ...
    public static void postJSON(boolean istokenId, final String url, final JSONObject json, final CallBac callBac) {
        ...
        //需要tokenid
        if (istokenId) {
            LogUtils.e("我的tokenid=" + getTokenId());
            builder.addHeader(AUTHORIZATION, "Bearer " + getTokenId());
        }
    ...
    public static String getTokenId() {
        if (TextUtils.isEmpty(tokenId)) {
            tokenId = TreadApplication.getInstance().sp.getString("tokenid", "");
        }
        return tokenId;
    }
    ...
    public static void setTokenId(String tokentid) {
        TreadApplication.getInstance().sp.edit().putString("tokenid", tokentid).commit();
        tokenId = tokentid;
    }
