...
/**
 * 屏幕适配
 * 分辨率改变时先运行main，再签名打包就可以适配
 * */
public class DimenTool {
    static DecimalFormat decimalFormat;
    public static void gen() {
        //以此文件夹下的dimens.xml文件内容为初始值参照
        File file = new File("./treadmill/src/main/res/values/dimen.xml");
...
//                    sw768.append(start).append(num * 1.28).append(end).append("\r\n");
                    ...
                    sw768.append(start).append(decimalFormat.format(num * 1)).append(end).append("\r\n");
                } else {
            ...
            System.out.println(sw768);
            String sw480file = "./treadmill/src/main/res/values-sw480dp-land/dimen.xml";
            String sw600file = "./treadmill/src/main/res/values-sw600dp-land/dimen.xml";
            String sw768file = "./treadmill/src/main/res/values-sw768dp-land/dimen.xml";
            //将新的内容，写入到指定的文件中去
