...
public class CustomUser5Fragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
	private View view;
	...
	public void onResume() {
		super.onResume();
		initData();
		TreadApplication.setMediaPlayer(getContext(),R.raw.custom5);
	}

	private void initData() {
		userId="User" + MainActivity.getUserIndex() + "Custom5";
		...
		custom_ll_start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
                ((CustomModelFragment)(CustomUser5Fragment.this.getParentFragment())).saves();
			}
		});
