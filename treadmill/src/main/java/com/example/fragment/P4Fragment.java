...
public class P4Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{1, 2, 2, 3, 3, 4, 4, 6, 6, 7, 7, 8, 8, 10, 11, 12, 13, 11, 10, 10, 8, 8, 7, 7, 5, 5, 4, 4, 3, 2};
