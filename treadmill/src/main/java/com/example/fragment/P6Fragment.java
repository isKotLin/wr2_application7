...
public class P6Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{2, 3, 3, 4, 4, 5, 5, 7, 7, 9, 9, 10, 10, 12, 13, 14, 14, 13, 12, 12, 10, 10, 9, 9, 6, 6, 5, 5, 3, 3};
