...
public class P8Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{2, 3, 3, 5, 5, 6, 6, 8, 8, 10, 10, 12, 12, 14, 14, 14, 14, 14, 13, 13, 11, 11, 9, 9, 7, 7, 6, 6, 3, 3};
