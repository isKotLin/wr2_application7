...
public class P63Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private void initData() {
        dataRec = new double[]{2, 4, 4, 6, 6, 6, 6, 7, 7, 7, 7, 10, 10, 10, 12, 13, 13, 14, 13, 13, 12, 12, 10, 10, 7, 7, 5, 5, 3, 3};
