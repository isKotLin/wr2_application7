...
public class P48Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private void initData() {
        dataRec = new double[]{4, 9, 14, 9, 4, 4, 9, 14, 9, 4, 4, 9, 14, 9, 4, 4, 9, 14, 9, 4, 4, 9, 14, 9, 4, 4, 9, 14, 9, 4};
