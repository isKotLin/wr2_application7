...
public class P47Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private void initData() {
        dataRec = new double[]{4, 8, 12, 8, 4, 4, 8, 12, 8, 4, 4, 8, 12, 8, 4, 4, 8, 12, 8, 4, 4, 8, 12, 8, 4, 4, 8, 12, 8, 4};
