...
public class P22Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private TextView pre_tv_sport;
    private void initData() {
        dataRec = new double[]{3, 4, 5, 6, 7, 8, 9, 10, 10, 11, 11, 12, 12, 13, 13, 13, 13, 12, 12, 11, 11, 10, 10, 9, 8, 7, 6, 5, 4, 3};
