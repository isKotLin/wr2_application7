...
public class CustomUser4Fragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
	private View view;
	...
	public void onResume() {
		super.onResume();
		initData();
		TreadApplication.setMediaPlayer(getContext(),R.raw.custom4);
	}

	private void initData() {
		userId = "User" + MainActivity.getUserIndex() + "Custom4";
		...
		custom_ll_start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
                ((CustomModelFragment)(CustomUser4Fragment.this.getParentFragment())).saves();
			}
		});
