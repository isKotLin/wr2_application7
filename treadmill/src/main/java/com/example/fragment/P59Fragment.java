...
public class P59Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private void initData() {
        dataRec = new double[]{2, 2, 2, 4, 4, 4, 4, 4, 4, 6, 6, 6, 6, 6, 8, 8, 10, 10, 12, 12, 10, 10, 8, 8, 6, 6, 4, 4, 2, 2};
