...
public class CustomUser2Fragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
	private View view;
	...
	public void onResume() {
		super.onResume();
		initData();
		TreadApplication.setMediaPlayer(getContext(),R.raw.custom2);
	}

	private void initData() {
		userId = "User" + MainActivity.getUserIndex() + "Custom2";
		...
		custom_ll_start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				((CustomModelFragment)(CustomUser2Fragment.this.getParentFragment())).saves();
			}
		});
