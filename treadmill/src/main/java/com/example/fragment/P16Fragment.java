...
public class P16Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{4, 5, 6, 7, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 13, 13, 12, 12, 11, 11, 10, 9, 8, 7, 6, 5, 4};
