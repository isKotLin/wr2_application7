...
public class P19Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{1, 2, 2, 3, 4, 5, 6, 7, 7, 8, 8, 9, 9, 10, 10, 10, 10, 9, 9, 8, 8, 7, 7, 6, 5, 4, 3, 2, 2, 1};
