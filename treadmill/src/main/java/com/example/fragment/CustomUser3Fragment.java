...
public class CustomUser3Fragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
	...
	public void onResume() {
		super.onResume();
		initData();
		TreadApplication.setMediaPlayer(getContext(),R.raw.custom3);
	}
	private void initData() {
		userId = "User" + MainActivity.getUserIndex() + "Custom3";
		...
		custom_ll_start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				((CustomModelFragment)(CustomUser3Fragment.this.getParentFragment())).saves();
			}
		});
...
//                + customTimes[wv_individual.getCurrentItem()]
		);
	}
