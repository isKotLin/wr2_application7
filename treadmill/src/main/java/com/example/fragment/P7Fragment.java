...
public class P7Fragment extends BaseFragment {
    View view;
    ...
    private void initData() {
        dataRec = new double[]{2, 3, 3, 5, 5, 6, 6, 8, 8, 9, 9, 10, 10, 12, 13, 14, 13, 13, 12, 12, 10, 10, 9, 9, 6, 6, 6, 6, 3, 3};
