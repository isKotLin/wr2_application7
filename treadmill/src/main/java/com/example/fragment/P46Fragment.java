...
public class P46Fragment extends BaseFragment {
    private static double[] dataRec;
    private static int[] dataLine;
    private void initData() {
        dataRec = new double[]{4, 7, 10, 7, 4, 4, 7, 10, 7, 4, 4, 7, 10, 7, 4, 4, 7, 10, 7, 4, 4, 7, 10, 7, 4, 4, 7, 10, 7, 4};
